...
public class AlteraProdutoFornecedor extends Produto implements Serializable {
	...
	public static void main(String[] args) {
		...
		do {
			...
			try {
				File directory = new File("FORNECEDORES/ATACADISTA/CATEGORIA/"+ categoria +"/");
				...
				Produto produtoLeitura = (Produto) ArquivoSerializadoUtilFornecedor.lerArquivoSerializado("atacadista",
						categoria, idLeitura);
				...
				if (opcao.equals("1")) {
					...
					case 1:
						System.out
								.println("O nome atual é: " + produtoLeitura.getNome() + "\n" + "Insira o novo nome: ");
					...
					case 2:
						System.out.println(
								"O preço atual é: " + produtoLeitura.getPrecovenda() + "\n" + "Insira o novo preço: ");
					...
					boolean gravou = ArquivoSerializadoUtilFornecedor.gravaObjetoSerializado(categoria,
							produtoAlterado.getId(), produtoLeitura);
